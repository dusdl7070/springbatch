...
import hhy.study.springbatch.job.chunk.flow.DecideJobConfig;
...
@ContextConfiguration(classes = {DecideJobConfig.class})
@SpringBootTest
class DecideJobApplicationTest {
    ...
    @Autowired
    public DecideJobApplicationTest(@Qualifier("decideJob") Job job, JobLauncher jobLauncher, JobRepository jobRepository) {
        this.job = job;
